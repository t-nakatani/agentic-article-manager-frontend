...
function TrendSection({ title, articles, onDelete }: TrendSectionProps) {
  ...
  return (
    <div 
      className="mb-0 border-2 border-theme-200 dark:border-theme-800 rounded-lg p-4 bg-gradient-to-r from-theme-50 to-white dark:from-theme-950 dark:to-theme-900 cursor-pointer"
