...
export function TrendArticleCard({ article }: TrendArticleCardProps) {
  ...
  return (
    <div className="flex flex-col rounded-md border border-theme-200 dark:border-theme-800 bg-card overflow-hidden hover:border-theme-300 dark:hover:border-theme-700 transition-colors shadow-sm">
      {/* ヘッダー部分 */}
